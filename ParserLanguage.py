...
class Parser:
    ...
    def print_tree(self, output=True):
        ...
        print('grammar[0][0] = ',self.grammar[0][0])
...
if __name__ == '__main__':
    grammar_file = str(input('Masukkan Nama File Grammar : '))
